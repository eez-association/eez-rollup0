...
# Deployment metadata for scripts and for rendering a node TOML file.
...
echo
echo "deploy: ready. Copy the public bindings into eez-composer.toml before starting the node."
