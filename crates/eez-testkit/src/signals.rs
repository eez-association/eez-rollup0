...
pub const DERIVER_RESUMED_PLACEMENT: &str = "eez.deriver.resumed.placement";
pub const DERIVER_RESUMED_APPENDED: &str = "eez.deriver.resumed.appended";
pub const DERIVER_SAFE_RETREATED_FOR_RESUME: &str = "eez.deriver.safe.retreated_for_resume";
