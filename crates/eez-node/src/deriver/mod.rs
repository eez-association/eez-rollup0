//! L1-derived L2 consensus: subscribes to [`L1Event`](crate::l1::L1Event)s,
//! decodes posted batches, and drives the
//! [`BlockCommitterHandle`](crate::driver::BlockCommitterHandle) to keep
...
// Mirrors the old eez-deriver crate layout (deriver.rs at crate root).
