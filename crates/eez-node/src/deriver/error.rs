...
/// Error returned by [`Deriver`](crate::deriver::Deriver) operations.
#[derive(Debug)]
...
impl DeriverError {
    ...
    pub(crate) fn l1_scan(err: crate::l1::L1Error) -> Self {
...
impl From<crate::driver::DriverError> for DeriverError {
