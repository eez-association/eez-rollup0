...
use crate::driver::timing::RollupTiming;
...
pub enum SlotEvent {
    ...
    /// current head and
    /// [`RollupTiming::per_trigger_composition`](crate::driver::RollupTiming::per_trigger_composition)
...
///
/// [`BlockCommitterHandle::commit_derived`]: crate::driver::block_committer::BlockCommitterHandle::commit_derived
#[derive(Debug)]
...
pub fn spawn_l1_anchored(
    mut source: crate::l1::L1HeadStream,
    timing: RollupTiming,
