//! Per-rollup state held by the [`Composer`](crate::composer::Composer) umbrella.
//!
...
use crate::l1::{L1CanonicalHead, L1Error, L1Result};

use crate::composer::held_pool::HeldPool;
