...
/// [`MAX_BUNDLE_ATTEMPTS`](crate::composer::composer::MAX_BUNDLE_ATTEMPTS) as a
...
mod tests {
    ...
    fn tx(tag: u8) -> HeldTx {
        ...
        HeldTx {
            ...
            nonce: u64::from(tag),
            direction: crate::composer::ingress::Direction::Inbound,
        }
    }
    ...
    fn reinserted_failure_preserves_nonce_reservations() {
        let held_pool = crate::composer::HeldPool::new();
        let original = tx(1);
