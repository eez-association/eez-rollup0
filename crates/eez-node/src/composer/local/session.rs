...
use crate::inspector::{OverlayChannelHandle, SessionInspectorFactory};
...
pub struct LocalExecutionSession {
    ...
    /// [`crate::inspector::SessionInspector`] built from this factory — forwarding
...
impl LocalExecutionSession {
    ...
    /// [`crate::inspector::SessionInspector`] so proxy CALLs
    ...
    /// [`crate::inspector::OverlayChannel`] side-channel), so
    ...
    /// supplied [`crate::inspector::SessionInspector`] so proxy CALLs detected during
    ...
    fn execute_internal_with_inspector(
        &mut self,
        inspector: crate::inspector::SessionInspector<'_>,
        destination: &Address,
        calldata: &Bytes,
        value: &U256,
        source_address: &Address,
