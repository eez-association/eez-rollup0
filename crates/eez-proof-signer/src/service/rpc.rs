...
impl Prover for ProveSvc {
    ...
    async fn prove(
        ...
        event!(
            ...
            validated_window_pre_block_hash = %attestation_material.validated_window_pre_block_hash,
            validated_window_post_block_hash = %attestation_material.validated_window_post_block_hash,
